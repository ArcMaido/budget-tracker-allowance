...
- Install Flutter SDK (Dart SDK is included with Flutter).
- Install Android Studio (for Android SDK, platform tools, emulator).
- Install VS Code + Flutter and Dart extensions (optional but recommended).
- On Windows desktop builds, install Visual Studio Build Tools with C++ workload.
